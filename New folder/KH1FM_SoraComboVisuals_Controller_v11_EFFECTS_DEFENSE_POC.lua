...
-- Combined Sora combo/visual controller v11 effects/defense proof of concept.
--
-- REQUIRED MSET
...
--   D4 Guard: Ripple visual/effect controls plus experimental stretched defense
--   DC Dodge Roll: Zantetsuken visual plus stretched Dodge Roll defense events
--
...
--   The diagnostic found no standalone invulnerability byte in Sora's first
--   0x400 runtime bytes. v11 instead stretches Dodge Roll's native timed
--   type-4 defensive/collision events across each 100-frame replacement.
--   This is an inferred binary-format POC and must be verified against a hit.
--
...
local function log(message)
    ConsolePrint("[SoraComboVisualsV11] " .. message)
end
...
function _OnInit()
    ...
    log("READY for the v11 effects/defense POC MSET.")
    ...
    log("Guard/Dodge use stretched native Dodge Roll defensive/collision events.")
