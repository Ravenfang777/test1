...
--     B. one v12 aerial replacement (CC/CD into its F7 visual).
--
...
--   2. Keep KH1FM_SoraComboVisuals_Controller_v12_INVULNERABILITY.lua enabled.
...
--        KH1FM_RagnarokProjectile_ControllerCompare_v1_Report.txt
--        KH1FM_RagnarokProjectile_ControllerCompare_v1_Snapshots.bin
...
local function diagnosticPrint(message)
    ConsolePrint("[RagnarokProjectileCompareV1] " .. message)
end
...
function _OnInit()
    ...
    previousSora = 0
    reportLines = {
        "KH1FM Ragnarok projectile controller comparison v1",
        "Game memory writes: NONE",
        "Required companion: v12 INVULNERABILITY controller and its v11 MSET.",
    ...
    diagnosticPrint("Keep v12 enabled; remove the standalone defense v2 test.")
