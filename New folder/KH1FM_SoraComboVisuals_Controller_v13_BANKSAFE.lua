...
--   D4 Guard: Ripple visual/effect controls plus full-animation invulnerability
--   DC Dodge Roll: Zantetsuken visual plus full-animation invulnerability
--
...
function _OnInit()
    ...
    log("Guard/Dodge apply verified Sora +0x00 bit 0x80 for their full duration.")
